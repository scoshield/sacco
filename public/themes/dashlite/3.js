...
/***/ "./js/vendors/nioapp/nioapp.min.js":
/*!*****************************************!*\
  !*** ./js/vendors/nioapp/nioapp.min.js ***!
  \*****************************************/
...
var NioApp = function (e, t, a) {
  ...
  function n(t) {
    t = void 0 === t ? e : t, i.docReady.concat(i.docReadyDefer).forEach(function (e) {
      e(t);
    });
  }

  function s(t) {
    t = "object" == _typeof(t) ? e : t, i.winLoad.concat(i.winLoadDefer).forEach(function (e) {
      e(t);
    });
  }

  function c(t) {
    t = "object" == _typeof(t) ? e : t, i.onResize.concat(i.onResizeDefer).forEach(function (e) {
      e(t);
    });
  }
...
NioApp = function (r, l) {
  ...
  return l.fn.exists = function () {
    ...
    for (var a = t ? t + "-" : "", o = e ? e.split(" ") : "", i = 0; i < o.length; i++) {
      o[i] = a + o[i];
    }

    return o.toString().replace(",", " ");
  }, r.BS = {}, r.TGL = {}, r.Ani = {}, r.Addons = {}, r.Slider = {}, r.Picker = {}, r.Win = {
    height: t.height(),
    width: t.width()
  }, r.Break = {
    mb: 420,
    ...
    var a,
        o,
        i = t || 1;
    if (/^#([A-Fa-f0-9]{3}){1,2}$/.test(e)) return 3 === (a = e.substring(1).split("")).length && (a = [a[0], a[0], a[1], a[1], a[2], a[2]]), o = [(a = "0x" + a.join("")) >> 16 & 255, a >> 8 & 255, 255 & a].join(","), 1 <= i ? "rgba(" + o + ")" : "rgba(" + o + "," + i + ")";
    ...
    !0 === r.State.isTouch ? c.addClass("has-touch") : c.addClass("no-touch"), e(), !0 === r.State.isRTL && c.addClass("has-rtl"), c.addClass("nk-" + a);
    r.Host.name.split(".").indexOf(r.Host.locat);
    t.on("resize", e);
  }, r.ColorBG = function () {
    function e(e, t) {
      var a = l(e),
          o = t || "bg",
          i = a.data(o);
      "" !== i && ("bg-color" === o ? a.css("background-color", i) : "bg-image" === o ? a.css("background-image", 'url("' + i + '")') : a.css("background", i));
    }
    ...
    l("[data-color]").each(function () {
      var e, t, a, o;
      e = "color", t = l(this), a = e || "color", "" !== (o = t.data(a)) && t.css("color", o);
    });
    ...
    r.Win.width < i ? setTimeout(function () {
      r.Win.width < i && l(o).addClass(s.classAdd);
    }, s.timeOut) : l(o).removeClass(s.classAdd);
    ...
    l(e).exists() && l(e).on("click", function (e) {
      var t = l(this),
          a = t.data("target"),
          o = l("#" + a);
      e.preventDefault(), o.hasClass(i.showClass) ? (t.add(o).addClass(i.hideClass).removeClass(i.showClass), o.attr("type", "password")) : (t.add(o).addClass(i.showClass).removeClass(i.hideClass), o.attr("type", "text"));
    });
    ...
    var a = {
      ...
      has: "has"
        ...
        n = i;
    o.prefix = !1 !== o.prefix ? o.prefix : "", o.has = "" !== o.has ? o.has + "-" : "", n = "" !== o["class"] ? o["class"] : o.has + n, l("." + o.prefix + i).exists() && !c.hasClass(n) && c.addClass(n);
  }, r.Toggle = {
    trigger: function trigger(e, t) {
      ...
      n.data("toggle-overlay") && (o.overlay = o.olay), s && (o.body = "toggle-shown"), i.toggleClass(o.active), n.toggleClass(o.content), !0 === o.toggle && n.slideToggle(o.speed), o.body && c.toggleClass(o.body), o.overlay && this.overlay(n, o.overlay, o);
    },
    removed: function removed(e, t) {
      var a = {
        ...
        olay: "toggle-overlay"
          ...
          n = l("[data-" + o.data + "=" + e + "]"),
          s = n.data("toggle-body");
      n.data("toggle-overlay") && (o.overlay = o.olay), s && (o.body = "toggle-shown"), (i.hasClass(o.active) || n.hasClass(o.content)) && (i.removeClass(o.active), n.removeClass(o.content), !0 === o.toggle && n.slideUp(o.speed)), o.body && c.hasClass(o.body) && c.removeClass(o.body), o.close && (!0 === o.close.profile && this.closeProfile(n), !0 === o.close.menu && this.closeMenu(n)), o.overlay && this.overlayRemove(o.overlay);
    },
    overlay: function overlay(e, t, a) {
      if (!0 === a["break"]) {
        var o = l(e).data("toggle-screen");
        a["break"] = r.Break[o];
      }
    ...
    dropMenu: function dropMenu(e, t) {
      ...
      o.speed = 5 < n.children().length ? o.speed + 20 * n.children().length : o.speed, n.slideToggle(o.speed).find("." + o.child).slideUp(o.speed), i.toggleClass(o.active).siblings().removeClass(o.active).find("." + o.child).slideUp(o.speed);
    },
    ...
    var t = e || ".modal";
    l(t).exists() && "function" == typeof l.fn.modal && l(t).on("shown.bs.modal", function () {
    ...
    l(e).exists() && "function" == typeof l.fn.slick && l(e).each(function () {
      var e = {
    ...
    if (l(e).exists() && "function" == typeof l.fn.knob) {
      var a = {
        min: 0
      },
          o = t ? d(a, t) : a;
    ...
    l(e).exists() && "undefined" != typeof noUiSlider && l(e).each(function () {
