                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="multiplier"
                                       class="control-label">{{trans_choice('loan::general.multiplier',1)}}</label>
                                <input type="text" name="multiplier" value="{{ old('multiplier') }}"
                                       id="multiplier"
                                       class="form-control numeric @error('multiplier') is-invalid @enderror"
                                       v-model="multiplier" required>
                                @error('multiplier')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <div id="accounting_rule_div" v-if="accounting_rule==='cash'">
                        <div class="row gy-4">
                            <div class="col-md-6">
                              ...
                              <div class="col-md-6">
                                <div class="form-group">
                                    <label for="loan_repayment_chart_of_account_id"
                                           class="control-label">{{trans_choice('loan::general.loan_repayment',1)}}</label>
                                    <v-select label="name" :options="assets"
                                              :reduce="asset => asset.id"
                                              v-model="loan_repayment_chart_of_account_id">
                                        <template #search="{attributes, events}">
                                            <input
                                                    autocomplete="off"
                                                    class="vs__search @error('loan_repayment_chart_of_account_id') is-invalid @enderror"
                                                    v-bind="attributes"
                                                    v-bind:required="!loan_repayment_chart_of_account_id"
                                                    v-on="events"
                                            />
                                        </template>
                                    </v-select>
                                    <input type="hidden" name="loan_repayment_chart_of_account_id"
                                           v-model="loan_repayment_chart_of_account_id">
                                    @error('loan_repayment_chart_of_account_id')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                    @enderror
    ...
    <script>
        var app = new Vue({
            ...
            data: {
                ...
                multiplier: "{{old('multiplier', $loan_product->multiplier)}}",
                ...
                loan_repayment_chart_of_account_id: parseInt("{{old('loan_repayment_chart_of_account_id',$loan_product->loan_repayment_chart_of_account_id)}}"),
