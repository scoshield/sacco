...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>{{trans_choice('loan::general.disbursement',1)}}</h1>
                </div>
                <div class="col-sm-6">
                ...
                <form method="get" action="{{Request::url()}}" class="">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label"
                                       for="status">{{trans_choice('loan::general.loan',1)}} {{trans_choice('loan::general.status',1)}}</label>
                                <select class="form-control select2" name="status" id="status">
                                    <option value="" disabled
                                        ...
                                        <option value="written_off" @if($status=='written_off') selected @endif>Writtern Off </option>
                                </select>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-body table-responsive p-0">
                    ...
                    <table class="table table-bordered table-striped table-condensed table-hover">
                        ...
                        <tr style="background-color: #D1F9FF">
                            ...
                            <th>{{trans_choice('core::general.group',1)}}</th>
