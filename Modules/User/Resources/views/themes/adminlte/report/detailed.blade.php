            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    ...
                    <li class="breadcrumb-item"><a
                        ...
                        <li class="breadcrumb-item"> <a
                                    href="{{url('report/user/register')}}">{{trans_choice('user::general.register',1)}} {{trans_choice('report::general.report',2)}}</a></li>
            ...
            <div class="box box-white">
                <div class="box-body table-responsive no-padding">
                    ...
                    <table class="table table-bordered table-condensed table-hover">
                        ...
                        <tr>
                            <td colspan="12"><h3 class="text-center" style="text-transform: uppercase;"> {{trans_choice('savings::general.savings',1)}}</h3></td>
                        </tr>
                        ...
                        $expenses_total = 0;
                        ?>
                        @foreach($data->savings_transactions as $key)                           
                            <tr>
                                <td>{{ $key->id }}</td>
                                <td>
                    ...
                    <table class="table table-bordered table-condensed table-hover">
                        ...
                        <tr>
                            <td colspan="12"><h3 class="text-center" style="text-transform: uppercase;"> {{trans_choice('loan::general.loan',1)}}</h3></td>
                        </tr>
                        <tr style="background-color: #D1F9FF">
                            <th>{{trans_choice('core::general.id', 1)}}</th>
                            <th>{{trans_choice('user::general.register',1)}}</th>
                        ...
                        $expenses_total = 0;
                        ?>
                        @foreach($data->loan_transactions as $key)                           
                            <tr>
                                <td>{{ $key->id }}</td>
                                <td>
                                    <a href="{{url('report/user/detailed_register?register_id='.$key->id.'&start_date='.$start_date.'&end_date='.$end_date.'&user_id='.$user_id)}}">{{$key->code}}</a>
