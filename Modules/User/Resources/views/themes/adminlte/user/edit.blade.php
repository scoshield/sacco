            ...
            <div class="card card-bordered card-preview">
                <div class="card-body">
                    ...
                    <div class="row gy-4">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('user_control_account') is-invalid @enderror" name="user_control_account"
                                        id="user_control_account" v-model="user_control_account">
                                    <option value=""></option>
                    ...
                    <div class="row gy-4">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="gender" class="control-label">{{trans('user::general.status')}}</label>
    ...
    <script>
        var app = new Vue({
            ...
            data: {
                ...
                user_control_account: "{{old('user_control_account',$user->user_control_account)}}",
