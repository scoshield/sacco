                    ...
                    <tr>
                        ...
                        <th>
                            <a href="{{table_order_link('savings_officer')}}">
                                <span>{{ trans_choice('core::general.group',1) }}</span>
                            </a>
                        </th>
                        <th>
                        ...
                        <tr>
                            ...
                            <td>
                                <!-- <a href="{{url('user/'.$key->id.'/show')}}"> -->
                                    <strong>{{$key->group_name}}</strong>
                                <!-- </a> -->
                            </td>
                            <td>
                                <a href="{{url('client/'.$key->cid.'/show')}}">
                                    <span>{{$key->first_name}} {{$key->middle_name}} {{$key->last_name}}</span>
                                </a>
                            </td>
                            <td>
                            ...
                            <td>
                                <span>{{number_format($key->credit - $key->debit,2)}}</span>
                            </td>
                            <td>
