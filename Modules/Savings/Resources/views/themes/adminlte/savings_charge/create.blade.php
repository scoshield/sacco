...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a
                                    href="{{url('savings/charge')}}">{{ trans_choice('savings::general.charge',2) }}</a>
                        </li>
    ...
    <section class="content" id="app">
        <form method="post" action="{{ url('savings/charge/store') }}">
            {{csrf_field()}}
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="allow_override"
                                       class="control-label">{{trans('savings::general.override')}}</label>
    ...
    <script>
        var app = new Vue({
            ...
            data: {
                ...
                savings_charge_option_id: parseInt("{{old('savings_charge_option_id')}}"),
                savings_charge_type_id: parseInt("{{old('savings_charge_type_id')}}"),
                amount: "{{old('amount')}}",
                active: "{{old('active',1)}}",
