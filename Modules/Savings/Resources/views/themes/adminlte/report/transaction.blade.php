                ...
                <form method="get" action="{{Request::url()}}" class="">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="control-label"
                                       for="savings_product_id">{{trans_choice('savings::general.savings',1)}}</label>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="control-label"
                                       for="client_id">{{trans_choice('client::general.client',1)}}</label>
                                <select class="form-control select2" name="client_id" id="client_id">
                                    <option value=""
                                            selected>{{trans_choice('core::general.all',1)}}</option>
                                    @foreach($clients as $key)
                                        <option value="{{$key->id}}"
                                                @if($client_id==$key->id) selected @endif>{{$key->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
