...
@section('title')
    {{ trans_choice('core::general.edit',1) }} {{ trans_choice('savings::general.deposit',1) }}
@endsection
@section('content')
    <div class="box box-primary">
        <div class="box-header with-border">
            <h6 class="box-title">{{ trans_choice('core::general.edit',1) }} {{ trans_choice('savings::general.deposit',1) }}</h6>

            <div class="box-tools pull-right">

            </div>
        </div>
        <form method="post" action="{{url('savings/deposit/'.$savings_transaction->id.'/update')}}" class="">
            {{csrf_field()}}
            <div class="box-body">
                @if (count($errors) > 0)
