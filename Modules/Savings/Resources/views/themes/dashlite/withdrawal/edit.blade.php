...
@section('title')
    {{ trans_choice('core::general.edit',1) }} {{ trans_choice('savings::general.withdrawal',1) }}
@endsection
@section('content')
    <div class="box box-primary">
        <div class="box-header with-border">
            <h6 class="box-title">{{ trans_choice('core::general.edit',1) }} {{ trans_choice('savings::general.withdrawal',1) }}</h6>

            <div class="box-tools pull-right">

            </div>
        </div>
        <form method="post" action="{{url('savings/withdrawal/'.$savings_transaction->id.'/update')}}" class="">
            {{csrf_field()}}
            <div class="box-body">
                @if (count($errors) > 0)
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="amount" class="form-control numeric"
                           placeholder=""
                           value="{{$savings_transaction->amount}}" id="amount" required>
                </div>
                <div class="form-group">
                    <label class="control-label"
                    ...
                    <input type="text" name="date" class="form-control date-picker"
                           placeholder=""
                           value="{{$savings_transaction->submitted_on}}" id="date" required>
                </div>
                <div id="payment_details">
                    <div class="form-group">
                        ...
                        <select class="form-control select2" name="payment_type_id" id="payment_type_id" required>
                            ...
                            @foreach($payment_types as $key)
                                <option value="{{$key->id}}"
                                        @if($savings_transaction->payment_detail->payment_type_id==$key->id) selected @endif>{{$key->name}}</option>
                            @endforeach
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="account_number" class="form-control"
                               placeholder=""
                               value="{{$savings_transaction->payment_detail->account_number}}" id="account_number">
                    </div>
                    <div class="form-group">
                        <label class="control-label"
                        ...
                        <input type="text" name="cheque_number" class="form-control"
                               placeholder=""
                               value="{{$savings_transaction->payment_detail->cheque_number}}" id="cheque_number">
                    </div>
                    <div class="form-group">
                        <label class="control-label"
                        ...
                        <input type="text" name="routing_code" class="form-control"
                               placeholder=""
                               value="{{$savings_transaction->payment_detail->routing_code}}" id="routing_code">
                    </div>
                    <div class="form-group">
                        <label class="control-label"
                        ...
                        <input type="text" name="receipt" class="form-control"
                               placeholder=""
                               value="{{$savings_transaction->payment_detail->receipt}}" id="receipt">
                    </div>
                    <div class="form-group">
                        <label class="control-label"
                        ...
                        <input type="text" name="bank_name" class="form-control"
                               placeholder=""
                               value="{{$savings_transaction->payment_detail->bank_name}}" id="bank_name">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label" for="description">{{trans_choice('general.description',1)}}</label>
                    <textarea name="description" class="form-control" id="description">{{$savings_transaction->payment_detail->description}}</textarea>
                </div>
            </div>
            <!-- /.box-body -->
