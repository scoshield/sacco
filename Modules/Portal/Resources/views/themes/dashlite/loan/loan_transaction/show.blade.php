...
@section('content')
    <div class="box box-primary">
        <div class="box-header with-border">
            <h6 class="box-title">{{ trans_choice('loan::general.transaction',1) }}  {{ trans_choice('core::general.detail',2) }}</h6>

            <div class="box-tools">
                <a href="{{url('portal/loan/transaction/'.$loan_transaction->id.'/pdf')}}" target="_blank"
                   class="btn btn-info btn-sm">{{ trans_choice('core::general.pdf',1) }}</a>
                <a href="{{url('portal/loan/transaction/'.$loan_transaction->id.'/print')}}" target="_blank"
