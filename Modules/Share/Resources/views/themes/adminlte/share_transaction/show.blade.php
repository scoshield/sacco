...
@section('title')
    {{ trans_choice('share::general.transaction',1) }}  {{ trans_choice('core::general.detail',2) }}
@endsection
@section('content')
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>
                        {{ trans_choice('share::general.transaction',1) }}  {{ trans_choice('core::general.detail',2) }}
                        <a href="{{url('share/transaction/'.$share_transaction->id.'/pdf')}}" target="_blank"
                           class="btn btn-info btn-sm">{{ trans_choice('core::general.pdf',1) }}</a>
                        <a href="{{url('share/transaction/'.$share_transaction->id.'/print')}}" target="_blank"
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a
                                    href="{{url('share/'.$share_transaction->savings_id.'/show')}}">{{ trans_choice('share::general.share',2) }}</a>
                        </li>
                        <li class="breadcrumb-item active">{{ trans_choice('share::general.transaction',1) }}  {{ trans_choice('core::general.detail',2) }}</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="card-body p-0">
                <table class="table  table-bordered table-hover table-striped" id="">
                    ...
                    <tr>
                        ...
                        <td>{{$share_transaction->submitted_on}}</td>
                    </tr>
                    <tr>
