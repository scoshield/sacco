...
@section('content')
    ...
    <section class="content" id="app">
        <form method="post" action="{{ url('client/group/'.$group->id.'/update') }}">
            {{csrf_field()}}
...
@section('scripts')
    <script>
        var app = new Vue({
            el: "#app",
            data: {
                group_name: "{{old('group_name',$group->group_name)}}",
                venue: "{{old('venue',$group->venue)}}",
                order_of_the_day: "{{old('order_of_the_day',$group->order_of_the_day)}}",
                day_of_the_week: "{{old('day_of_the_week',$group->day_of_the_week)}}",
