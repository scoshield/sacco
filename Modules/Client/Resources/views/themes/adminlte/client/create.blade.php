                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="external_id" v-model="external_id" id="external_id" class="form-control @error('external_id') is-invalid @enderror">
                            @error('external_id')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        <div class="form-group">
                            <label for="group_id" class="control-label">{{trans_choice('client::general.group',1)}}</label>
                            <select class="form-control @error('group_id') is-invalid @enderror" name="group_id" id="group_id" v-model="group_id">
                                <option value=""></option>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        <div class="form-group">
                            <label for="created_date" class="control-label">Registration Date</label>
